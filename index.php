...
<head>
  ...
  <link href="Front/CSS/index_style.css" rel="stylesheet" type="text/css">
...
<body>
  ...
  <nav class="menu-lateral">
    ...
    <ul>
      ...
      <li class="item-menu">
        <a href="Front/HTML/login_prof.php">
          <span class="icon"><i class="bi bi-person-workspace"></i></span>
          <span class="txt-link">Professor</span>
        </a>
      </li><!--PROFESSOR-->
      <li class="item-menu">
        <a href="Front/HTML/notas.php">
          <span class="icon"><i class="bi bi-sim-fill"></i></span>
  ...
  <main>
    ...
    <div class="background">
      ...
      <form class="form" action="Front/HTML/teste_login_aluno.php" method="POST">
        ...
        <a href="Front/HTML/cadastro_aluno.php" target="">Cadastrar-se</a>
